...
idCVar si_maxPlayers(				"si_maxPlayers",			"8",			CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_INTEGER, "max number of players allowed on the server", 1, 16 ); //Editado por stradex, hasta 16 jugadores 
...
idCVar si_overtime(					"si_overtime",				"1",			CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_BOOL, "Enable overtime while playing Tourney" );
idCVar si_overtime_duration(		"si_overtime_duration",		"2",			CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_INTEGER, "Duration in minutes of each overtime", 1, 10);
